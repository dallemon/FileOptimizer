...
#define KS_EXTENSION_AVIF	_T(" .avif ")
...
#define KS_EXTENSION_ALL	(StringReplace((KS_EXTENSION_BMP KS_EXTENSION_AVIF KS_EXTENSION_BMP KS_EXTENSION_CSS KS_EXTENSION_DLL KS_EXTENSION_EXE KS_EXTENSION_FLAC KS_EXTENSION_GIF KS_EXTENSION_GZ KS_EXTENSION_HTML KS_EXTENSION_ICO KS_EXTENSION_JPG KS_EXTENSION_JXL KS_EXTENSION_JS KS_EXTENSION_LUA KS_EXTENSION_MIME KS_EXTENSION_MKV KS_EXTENSION_MNG KS_EXTENSION_MP3 KS_EXTENSION_MP4 KS_EXTENSION_OBJ KS_EXTENSION_OGG KS_EXTENSION_OGV KS_EXTENSION_OLE KS_EXTENSION_PCX KS_EXTENSION_PDF KS_EXTENSION_PNG KS_EXTENSION_SQLITE KS_EXTENSION_SWF KS_EXTENSION_TAR KS_EXTENSION_TENCENTQQ KS_EXTENSION_TGA KS_EXTENSION_TIFF KS_EXTENSION_WAV KS_EXTENSION_WEBP KS_EXTENSION_XML KS_EXTENSION_ZIP KS_EXTENSION_7Z KS_EXTENSION_MISC), "  ", " ", TReplaceFlags() << rfReplaceAll))
