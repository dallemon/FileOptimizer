object frmOptions: TfrmOptions
  ...
  object tabOptions: TPageControl
    ...
    object pagGeneral1: TTabSheet
      ...
      object chkDoNotCreateBackups: TCheckBox
        Left = 7
        Top = 232
        Width = 281
        Height = 17
        Hint = 
          'When checked original files will not be backed up in the current' +
          ' folder as a .BAK files.'
        Caption = 'D&o not create backups'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 8
      end
    ...
    object pagMisc: TTabSheet
      ...
      ExplicitWidth = 0
      ExplicitHeight = 0
      object chkMiscDisable: TCheckBox
        Left = 7
        Top = 22
        Width = 281
        Height = 17
        Hint = 
          'Disable processing of other file types. This could imply lossing' +
          ' some edit capabilities such as PSD/PSB where text layers will b' +
          'e rasterized.'
        Caption = '&Disable'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 1
        OnClick = chkMiscDisableClick
      end
    ...
    object pagPDF: TTabSheet
      ...
      object spnPDFCustomDPI: TSpinEdit
        ...
        Height = 22
        Hint = 
          'When custom profile is chosen, it allows you to specify a custom' +
          ' DPI for downsampling images'
        Increment = 50
        MaxValue = 3000
        MinValue = 50
        ParentShowHint = False
